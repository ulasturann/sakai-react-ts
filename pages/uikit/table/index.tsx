...
import { Column, ColumnBodyType, ColumnFilterApplyTemplateOptions, ColumnFilterClearTemplateOptions, ColumnFilterElementTemplateOptions } from 'primereact/column';
...
const TableDemo = () => {
    const [customers1, setCustomers1] = useState<API.Customer[]>([]);
    const [customers2, setCustomers2] = useState<API.Customer[]>([]);
    const [customers3, setCustomers3] = useState<API.Customer[]>([]);
    ...
    const balanceTemplate = (rowData: API.Customer) => {
        return (
            <div>
    ...
    const getCustomers = (data: API.Customer[]) => {
        return [...(data || [])].map((d) => {
    ...
    const countryBodyTemplate = (rowData: API.Customer) => {
        return (
            <React.Fragment>
    ...
    const representativeBodyTemplate = (rowData: API.Customer) => {
    ...
    const dateBodyTemplate = (rowData: API.Customer) => {
    ...
    const balanceBodyTemplate = (rowData: API.Customer) => {
    ...
    const statusBodyTemplate = (rowData: API.Customer) => {
    ...
    const activityBodyTemplate = (rowData: API.Customer) => {
    ...
    const verifiedBodyTemplate = (rowData: API.Customer) => {
    ...
    const amountBodyTemplate = (rowData: API.Customer) => {
        return formatCurrency(rowData.amount);
    };

    const statusOrderBodyTemplate = (rowData: API.Customer) => {
    ...
    const imageBodyTemplate = (rowData: API.Customer) => {
    ...
    const priceBodyTemplate = (rowData: API.Customer) => {
        return formatCurrency(rowData.price);
    };

    const ratingBodyTemplate = (rowData: API.Customer) => {
        return <Rating value={rowData.rating} readOnly cancel={false} />;
    };

    const statusBodyTemplate2 = (rowData: API.Customer) => {
        return <span className={`product-badge status-${rowData.inventoryStatus?.toLowerCase()}`}>{rowData.inventoryStatus}</span>;
    };

    const rowExpansionTemplate = (data: API.Customer) => {
        return (
    ...
    const headerTemplate = (data: API.Customer) => {
        return (
            <React.Fragment>
    ...
    const footerTemplate = (data: API.Customer) => {
        return (
            <React.Fragment>
