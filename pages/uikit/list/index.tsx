...
import { API, LayoutType, SortOrderType } from '../../../types/global';
...
const ListDemo = () => {
    ...
    const [dataViewValue, setDataViewValue] = useState<API.Product[]>([]);
    const [globalFilterValue, setGlobalFilterValue] = useState('');
    const [filteredValue, setFilteredValue] = useState<API.Product[]>([]);
    ...
    const dataviewListItem = (data: API.Product) => {
        return (
    ...
    const dataviewGridItem = (data: API.Product) => {
        return (
    ...
    const itemTemplate = (data: API.Product, layout: LayoutType) => {
        if (!data) {
            return;
        }
