...
const InvalidStateDemo = () => {
    ...
    const [filteredCountries, setFilteredCountries] = useState<API.Country[]>([]);
            ...
            <div className="grid p-fluid">
                <div className="col-12 md:col-6">
                    ...
                    <div className="field">
                        ...
                        <Calendar inputId="calendar" value={value3} onChange={(e) => setValue3(e.value as Date)} className="p-invalid" showIcon />
                    </div>
                    <div className="field">
